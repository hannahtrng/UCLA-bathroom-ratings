...
class NginxConfigParser {
 ...
 protected:
  ...
  // Token type validation helpers (defined after TokenType enum)
  static bool IsValidTokenPredecessor(TokenType type);
  static bool CanFollowWithToken(TokenType type);
